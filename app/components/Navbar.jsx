                    ...
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
                          ...
                          >
                            <div className="flex items-center gap-4">
                              <Icon
                                ...
                                icon="line-md:edit"
                              />
                              <p className="font-semibold text-emGrey text-h6">Edit Profile</p>
                            </div>
                          </Link>
                        )}
                      </Menu.Item>
                      <Menu.Item>
                        ...
                        >
                          <div className="flex items-center gap-4">
                            ...
                            />
                            <p className="font-semibold text-emGrey text-h6">Notifications</p>
                          </div>
                        </Link>
                        )}
                      </Menu.Item>
                      <Menu.Item>
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <Icon
                              className={'text-emRed'}
                              fontSize={fn.rem(28)}
                              icon="solar:logout-2-outline"
                            />
                            <p className="font-semibold text-emGrey text-h6">Log Out</p>
                          </div>
                        </Link>
                        )}
                      </Menu.Item>
